"""
Django settings for PsevdoService project.
...
SECRET_KEY = 'django-insecure-neqfb2@%@_t!+ob%hnh5s3^#ukb8+)q7*jg9k28%^0l!3-faf2'
...
ROOT_URLCONF = 'PsevdoService.urls'
...
#         }
#     }
WSGI_APPLICATION = 'PsevdoService.wsgi.application'
